...
public class Account {
    ...
    @Column(precision = 13, scale = 2) // Declaring attribute characteristics in the database
    private BigDecimal balance;

    @Column(name = "additional_limit", precision = 13, scale = 2) // Declaring attribute characteristics in the database
